...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(PB0_TEMP_DATA_GPIO_Port, PB0_TEMP_DATA_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pin : PB0_TEMP_DATA_Pin */
  GPIO_InitStruct.Pin = PB0_TEMP_DATA_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(PB0_TEMP_DATA_GPIO_Port, &GPIO_InitStruct);
